...
var folder = normalize(os.userInfo().homedir + "\\downloads");
...
function mapCategories() {
    ...
    paths.forEach(function (location) {
        var extensions = categories[location];
...
function createTray() {
    var iconPath = path.join('favicon.ico');
    var tray = new electron_1.Tray(electron_1.nativeImage.createFromPath(iconPath));
    var contextMenu = electron_1.Menu.buildFromTemplate(trayMenu);
