export enum Tips {
  ...
  AUTO_SORT_ON_OFF = 'Use the <i class="material-icons">visibility</i> icon to set the folder on auto-sort, meaning when a file is placed on that folder, the rules will be checked and the file will be automatically moved if needed',
  MANUAL_SORT = 'Once you are happy with your rules set, use the <i class="material-icons">fact_check</i> icon to manually apply your sorting rules to the folder',
